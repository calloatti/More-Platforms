Think that the current platforms limit your creativity? Then this mod will let you add 4 new platforms to the game which can be build to the side of any building, giving more freedom of placing buildings as anything can be below these platforms.

##  How to use 
All platforms can be found under the paths tab. You can place them to the side of any cliff or a stack of levees.

##  Middle Platform 
~~These platforms can be placed nearly everywhere. They can be placed against any cliff, platform, building etc. It should be noted that this makes it possible to make floating buildings and as such is not advised when you like reality and game integrity.~~ 

##  Problems? 
In case you experience problems, please click [ THIS LINK ](https://mod.io/g/timberborn/r/troubleshooting-mod-setup) to go to a page containing the most frequent issues and see if yours is included. If your issue is not there, it can be the game or something changed which makes it result in a crash. If you are savvy enough, try to look for the mods that is making the game crash. If you determine that its this mod, then please message me in the modding channel of the the Timberborn discord. Or you can leave a comment below asking for help. 
...
##  Links
Source code 0.6: https://github.com/TobbyTheBobby/TimberbornMods  
Source code 1.0: https://github.com/calloatti/More-Platforms  
The mod is also on mod.io: https://mod.io/g/timberborn/m/moreplatforms
...
[ Donation Link ](https://www.paypal.com/donate/?hosted_button_id=5NDH2VEWPEKSU)
[ Patreon Link ](https://www.patreon.com/tobbert)
